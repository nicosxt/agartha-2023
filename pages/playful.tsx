              ...
              <div className="sm:text-center lg:text-center">
                <div className="px-4  pt-32 ">
                    <div className="pl-48 items-left pr-24">
                        ...
                        <p >Play is in our nature! Tasks, responsibilities can all be a lot more joyful if we turn them into fun games.
                        </p>
                        <p> We feel safe and cheerful if our culture can be safe and cheerful, and that all comes from the art of play!
                        </p>
                        <p>
