...
import { communityToJSON, getUserWithUsername, postToJSON } from '../../lib/firebaseConfig/init';
...
export async function getServerSideProps(context:any) {
    ...
    if (userDoc) {
        ...
        slugs.map(async(slug) => {
            ...
            const memberBatch = memberSnapshot.docs.map(d=>d.id);
    ...
    return {
        props: {user, posts, username, fetchedMembers}
    }
