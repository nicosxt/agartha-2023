...
export default function Dashboard(props: Props): any {
  ...
  const [navigation, setNavigation] = useState([
    ...
    {
      name: "Wiki",
      href: "https://yingru-qiu.gitbook.io/space-exchange/",
                ...
                <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                  ...
                  <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    <div className="flex-shrink-0 flex items-center px-4">
                      <img
                        className="h-16 w-16 rounded-full btn"
                        src={
                          user.avatarUrl
                            ? user.avatarUrl
                                ...
                                <Disclosure.Panel className="space-y-1">
                                  {item.children.map((subItem) => (
                                    <Link
                                      ...
                                      legacyBehavior
                                    >
                                      <Disclosure.Button className="group w-full flex items-center pl-11 pr-2 py-2 text-sm font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50">
                                        {subItem.name}
                                      </Disclosure.Button>
                                    </Link>
                                  ))}
                  ...
                  <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                    <Link href={"/"} legacyBehavior>
                      <button onClick={signOut}>
                        {" "}
                        <a className="mt-8 inline-flex items-left px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-indigo-600 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                          Signout
                        </a>
                      </button>
                    </Link>
          ...
          <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              ...
              <Link href={"/"} legacyBehavior>
                <button onClick={signOut}>
                  {" "}
                  <a className="mt-8 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-indigo-600 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Signout
                  </a>
                </button>
              </Link>
