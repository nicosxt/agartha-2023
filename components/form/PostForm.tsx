            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:mt-0 sm:col-span-2">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Title will be automatically generated based on your input.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  ...
                  ></textarea>
                  <p className="mt-2 text-sm text-gray-500">
                    Write a few sentences about what your room looks like,{" "}
                    <br /> and why you want to rent your room.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  ...
                  />
                  <p className="mt-1 max-w-2xl text-sm text-gray-500">
                    You could also leave an approximate address to protect your
                    privacy.
                  </p>
                </div>
              </div>
