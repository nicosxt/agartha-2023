                    ...
                    {/* <div date-rangepicker="true" className="flex items-center"> */}
                      <div className="relative">
                            ...
                            <input 
                                ...
                                name="start" type="date" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  " placeholder="Select date start"/>
                        </div>
                      ...
                      <div className="relative">
                        ...
                        <input
                            ...
                            name="end" type="date" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  " placeholder="Select date end"/>
                    </div>
                    </div>
                  </div>
