...
const items: MenuProps["items"] = [
  {
    label: (
      <a href="https://discord.gg/UAjzAx62Ug">
        <p className="font-mono text-[#0000FF] pr-4">Discord</p>
      </a>
    ),
    key: "0",
  },
  {
    label: (
      <a href="https://twitter.com/agartha_one">
        <p className="font-mono text-[#0000FF] pr-4">Twitter</p>
      </a>
    ),
    key: "1",
  },
  {
    label: (
      <a href="https://www.instagram.com/agartha_one/">
        <p className="font-mono text-[#0000FF] pr-4">Instagram</p>
      </a>
    ),
    key: "2",
  },
          ...
          <nav className="navbar" aria-label="Global">
              ...
              <div className="flex items-center justify-between w-full md:w-auto">
                <Link href="/">
                  ...
                  <img
                    ...
                    src="https://s2.loli.net/2022/10/24/U2uwF43q5IeXtYL.png"
                  />
                </Link>
              </div>
            </div>
            ...
            <div className="text-xs sm:text-sm mr-4 items-center flex justify-end sm:flex md:flex md:flex-1 lg:w-0 ">
              <Link href={"/map"} style={{ cursor: "pointer" }}>
                <p className="font-mono text-[#0000FF]  pr-3 sm:pr-8">
                  Communities
                </p>
              </Link>
              <a
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.notion.so/Agartha-4e4dcfd1584f420f87daf46ca2aaf25c"
              >
